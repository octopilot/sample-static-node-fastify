# sample-static-node-fastify

**One repo: static frontend + Node (Fastify TypeScript) API.**
...
op build-push
docker run -p 8081:8080 sample-static-node-fastify-api
docker run -p 8080:8080 -e PORT=8080 sample-static-node-fastify-frontend
```
